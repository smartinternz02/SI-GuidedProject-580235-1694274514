...
fun Screen3(navController: NavController) {
    ...
    courseList = courseList + GridModal("Biryani", R.drawable.biryani)
    courseList = courseList + GridModal("Fried Rice", R.drawable.friedrice)
    courseList = courseList + GridModal("Manchuria", R.drawable.manchuria)
    courseList = courseList + GridModal("Meals", R.drawable.meals)
    courseList = courseList + GridModal("Noodles", R.drawable.noodles)
    courseList = courseList + GridModal("Milk Shakes", R.drawable.milkshake)
    courseList = courseList + GridModal("Waffles", R.drawable.waffle)
